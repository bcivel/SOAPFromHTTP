...
<%@page import="org.soapfromhttp.service.CallSOAP"%>
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-ddTH:m:00.000+Z");

        String envelope = envelope2.replace("##DATE_JOUR##",dateFormat.format(calendar.getTime()));
        calendar.add(Calendar.DATE, 7);
        envelope = envelope.replace("##DATE_LIVRAISON##",dateFormat.format(calendar.getTime()));
